...
arcade.set_background_color(color.PERU) # black
arcade.start_render()
arcade.draw_rectangle_filled(300, 300, 50, 50, color.LIGHT_PINK) # white
...
# - Indian red and azure
# - Teal and light goldenrod yellow
# - peru and light pink